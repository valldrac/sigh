 ...
 */
package org.thoughtcrime.securesms.jobqueue;
...
import org.thoughtcrime.securesms.jobqueue.persistence.JobSerializer;
import org.thoughtcrime.securesms.jobqueue.persistence.PersistentStorage;
...
/**
 * A JobManager allows you to enqueue {@link org.thoughtcrime.securesms.jobqueue.Job} tasks
 * that are executed once a Job's {@link org.thoughtcrime.securesms.jobqueue.requirements.Requirement}s
 * are met.
 */
public class JobManager implements RequirementListener {
   ...
   * @return a {@link org.thoughtcrime.securesms.jobqueue.JobManager.Builder} used to construct a JobManager.
   */
  ...
  /**
   * Queue a {@link org.thoughtcrime.securesms.jobqueue.Job} to be executed.
   *
  ...
  public static class Builder {
    ...
    /**
     * The {@link org.thoughtcrime.securesms.jobqueue.requirements.RequirementProvider}s to register with this
     * JobManager.  Optional. Each {@link org.thoughtcrime.securesms.jobqueue.requirements.Requirement} an
    ...
    /**
     * The {@link org.thoughtcrime.securesms.jobqueue.dependencies.DependencyInjector} to use for injecting
    ...
    /**
     * The {@link org.thoughtcrime.securesms.jobqueue.persistence.JobSerializer} to use for persistent Jobs.
